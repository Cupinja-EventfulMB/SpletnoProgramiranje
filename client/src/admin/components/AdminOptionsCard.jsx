  ...
  return (
    <div className="relative shadow-md rounded-2xl w-80 h-60 bg-white hover:shadow-xl transition duration-200 group">
      <Link to={link}>
        ...
        />
        <div className="px-4 py-[8px] absolute w-full bottom-0 gap-2 left-0 bg-white rounded-2xl z-10 flex flex-col group-hover:bg-fuchsia-500 group-hover:text-white transition druation-200">
